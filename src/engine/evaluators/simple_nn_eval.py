# src/engine/evaluators/nn_eval.py
import chess
import torch
...
from ...io.to_tensor import create_tensor, NUM_PLANES
...
class NN_Eval(Eval):
    ...
    def __init__(self, board: chess.Board, model_path: Optional[str] = None, model_instance: Optional[nn.Module] = None):
        ...
        if model_instance:
            ...
            raise ValueError("NN_Eval requires either a model_path or a model_instance.")
