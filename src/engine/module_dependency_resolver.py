...
class DependencyResolver:
    ...
    def _validate_dependencies(self) -> None:
        ...
        Raises:
            DependencyResolutionError: If a feature is enabled but its
    ...
    def _validate_zobrist_dependencies(self) -> None:
        """Validate Zobrist hashing related dependencies."""
    ...
    def _validate_alpha_beta_dependencies(self) -> None:
        """Validate alpha-beta pruning related dependencies."""
        cfg = self.search_config

        if cfg.use_pvs and not cfg.use_alpha_beta:
            raise DependencyResolutionError(
    ...
    def _validate_move_ordering_dependencies(self) -> None:
        ...
        # Check other move ordering heuristics
    ...
    def _validate_search_refinement_dependencies(self) -> None:
        """Validate search refinement related dependencies."""
        cfg = self.search_config

        if cfg.use_iid and not cfg.use_iddfs:
            raise DependencyResolutionError(
                "Internal Iterative Deepening (IID) requires IDDFS"
            )
