...
# Configuration
STOCKFISH_PATH = "/usr/games/stockfish"  # Update with your Stockfish path
...
def main():
    ...
    try:
        ...
        if test_board:
            nn_evaluator = NN_Eval(test_board, model_path=None, model_instance=trained_model) # Pass the model instance directly
            ...
            stockfish_score = get_stockfish_eval(test_board, engine) * 20.0  # Scale to match NN_Eval.MAX_EVAL
