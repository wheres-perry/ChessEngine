...
import chess
import torch
from src.engine.evaluators.deep_cnn_eval import DeepCNN_Eval, DeepChessCNN, LightweightDeepCNN
...
class TestDeepCNNEval(unittest.TestCase):
    ...
    def test_different_configurations(self):
        ...
        configs = [
            ...
            {"architecture": "lightweight", "num_residual_blocks": 1, "base_channels": 32},
